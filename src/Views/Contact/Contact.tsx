    ...
    <motion.section
      ...
      <div className="mx-auto max-w-3xl">
        ...
        >
          ...
          <button
            type="submit"
            className="mt-6 w-full rounded-xl bg-gradient-to-r from-purple-500 via-pink-500 to-fuchsia-500 px-6 py-3 text-lg font-semibold text-white shadow-md transition-all duration-300 hover:scale-105 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-pink-400"
          >
            Send Message
          </button>
